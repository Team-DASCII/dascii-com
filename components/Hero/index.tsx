            ...
            <div className="w-full px-4">
              ...
              >
                ...
                <p className="dark:text-body-color-dark mb-12 text-base !leading-relaxed text-body-color sm:text-lg md:text-xl">
                  At Dascii, we redefine speed while offering custom and modern UI/UX solutions to assist you
                </p>
                <div className="flex flex-row items-center justify-left space-y-4 sm:space-x-4 sm:space-y-0">
                  <Link
                    href="https://nextjstemplates.com/templates/saas-starter-startup"
                    className="rounded-xl bg-primary px-4 py-4 text-base font-semibold text-white duration-300 ease-in-out hover:bg-primary/80"
                  >
                    Schedule a Free Meet
                  </Link>
